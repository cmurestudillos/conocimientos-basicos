...
class Game extends Component {
    ...
    guessNumber() {
        ...
        if (guessOutcome.accuracy === 0) {
            this.setState(() => ({ outcome: 'Tu ganas' }));
        } else {
                            ...
                            this.state.outcome !== 'you win' && <div>
                                    ...
                                    <ul className="nav nav-pills nav-fill">
                                        <li className="nav-item">
                                            <a className={`nav-link ${this.easyLinkClass()}`}
                                                onClick={this.startEasyGame}>Facil</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className={`nav-link ${this.mediumLinkClass()}`}
                                                onClick={this.startMediumGame}>Medio</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className={`nav-link ${this.hardLinkClass()}`}
                                                onClick={this.startHardGame}>Dificil</a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    <button className="btn btn-lg btn-success btn-block"
                                        onClick={this.guessNumber}>Jugar</button>
                                </div>
                            </div>
                        }
                        {
                        ...
                        }
                        {
                            this.state.outcome === 'you win' && <div className="form-group">
                                <div className="game-outcome">
                                    <p>{this.state.outcome}</p>
                                    <button className="btn btn-lg btn-success btn-block"
                                        onClick={this.startGame}>Jugar otra vez</button>
                                </div>
                            </div>
                        }
                    </div>
